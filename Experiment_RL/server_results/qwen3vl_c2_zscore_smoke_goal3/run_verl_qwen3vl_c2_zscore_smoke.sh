#!/usr/bin/env bash
# Qwen3-VL-8B-Thinking C2 zscored option-logit gain reward smoke on one H200.
...
RUN_NAME=${RUN_NAME:-qwen3vl8b_c2_zscore_smoke_len${MAX_RESPONSE_LENGTH}_n${ROLLOUT_N}_steps${TOTAL_STEPS}}
...
SAVE_FREQ=-1 \
TEST_FREQ=-1 \
PROJECT_NAME=qwen3vl_c2_zscore_smoke \
...
nvidia-smi
df -h / /data2
echo "QWEN3VL_C2_ZSCORE_SMOKE_EXIT_CODE=0"
