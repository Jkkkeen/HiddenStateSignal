...
def build_cli_args_from_config(config: dict[str, Any]) -> list[str]:
    ...
    - None: skipped
    - bool True: adds '--key'
    - bool False: skipped, except selected vLLM enable flags that need
      explicit --no-* overrides to beat vLLM defaults
    ...
    """
    negative_bool_flags = {"enable_chunked_prefill", "enable_prefix_caching"}
    cli_args = []
